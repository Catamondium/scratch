...
static int yyerror(SExpression ** expression, yyscan_t scanner,
                   const char *msg)
{
...
yy_symbol_value_print(FILE * yyoutput, int yytype,
                      ...
                      SExpression ** expression, yyscan_t scanner)
{
    FILE *yyo = yyoutput;
    YYUSE(yyo);
    YYUSE(expression);
...
#line 56 "Parser.y"             /* yacc.c:1646  */
        {
            (yyval.expression) =
                createOperation(eADD, (yyvsp[-2].expression),
                                (yyvsp[0].expression));
        }
...
#line 57 "Parser.y"             /* yacc.c:1646  */
        {
            (yyval.expression) =
                createOperation(eMULTIPLY, (yyvsp[-2].expression),
                                (yyvsp[0].expression));
        }
